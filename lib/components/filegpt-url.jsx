...
export default function FileGPTUrl({ filegpturl, setFilegpturl }) {
    ...
    return (<div className="space-y-2">
      ...
      <div className="flex gap-2">
        <div className="relative flex-1">
          <Input id="filegpt-url" type={"text"} value={inputValue} onChange={(e) => setInputValue(e.target.value)} placeholder="FileGPT Endpoint (e.g., http://localhost:8694)" className="pr-10"/>
        </div>
