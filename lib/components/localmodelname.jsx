...
export default function LMStudioModelName({ model_name, set_model_name }) {
    ...
    return (<div className="space-y-2">
      ...
      <div className="flex gap-2">
        <div className="relative flex-1">
          <Input id="api-key" type={"text"} value={inputValue} onChange={(e) => setInputValue(e.target.value)} placeholder="LM Studio Model name" className="pr-10"/>
        </div>
